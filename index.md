...
(Amazon S3) are provided. Each needs its own backend package
(`AzureStor` + `AzureAuth`, `googleCloudStorageR`, `paws.storage`),
which are Suggests rather than hard dependencies.
